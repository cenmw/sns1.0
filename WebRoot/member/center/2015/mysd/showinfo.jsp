...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>查看疏导</h2>
       ...
       <div class="vedio-list">
			...
			<table class="note-tabs1" width="710" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr style="padding-bottom:10px;">
				<td width="189" height="50" align="center"><font class="font14">发生的事情是什么？：</font></td>
				<td width="521" height="50" style="line-height:25px;"><s:property value="memberDiary.fssq" escape="false" /></td>
			  </tr>	
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">您的表现是什么样的？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.hzbx" escape="false" /></td>
			  </tr>	
			  
			  <s:if test="memberDiary.type==0">
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">孩子表现出的优点是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.bxjj" escape="false" /></td>
			  </tr>	
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">他发展的空间是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.fzkj" escape="false" /></td>
			  </tr>  
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">孩子需要的是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.hzxy" escape="false" /></td>
			  </tr>
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">您需要满足的是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.xymz" escape="false" /></td>
			  </tr>
			  </s:if>	
			 
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">我的感受是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.wdgs" escape="false" /></td>
			  </tr>	
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">我此时的内心需求是什么？：</font></td>
