...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/memberreport/list" target="rightFrame">举报信息</a></li>
				</ul>
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/memberpolice/list" target="rightFrame">拘留人员</a></li>
				</ul>
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/memberpolicesf/list" target="rightFrame">释放人员</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
