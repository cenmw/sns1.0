...
public class MemberContentManagerAction extends BaseAction {
	/**
	 * 会员文章 模块
	 */
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.DeleteMEMBERCONTENT })
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.ADDMEMBERCONTENT })
	public String save() {
		String msg = "修改成功！";
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.VIEWMEMBERCONTENT })
	public String info() {
		if (id > 0) {
	...
	@EmployeePermission(perm = { EmployeePermissionType.VIEWMEMBERCONTENT })
	public String list() {
		String hql = " from MemberBlog where type=2 and isdel=0";
		Map map = new HashMap();
		String parameter = "";
		// 默认排序 最新时间
		String sortstr = "";
		...
		pageBean.setAction("/manager/membercontent/list");
