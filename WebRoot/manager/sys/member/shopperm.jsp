...
<s:form action="saveAction" method="post" namespace="/manager/sys/member" theme="simple" onsubmit="return checkAction()">
     <input type="hidden" name="memberPerm.type" value="1"/>
     <s:hidden name="backurl"></s:hidden>
    	  ...
    	  <tr>
    	    ...
    	    <s:textfield cssClass="tin1" name="memberPerm.actionname" id="actionname" maxLength="50"></s:textfield>
   	        </td>
    	  ...
    	  <tr>
    	    <td class="yh">&nbsp;&nbsp;动作:</td>
    	    <td height="30">&nbsp;&nbsp;
   	        <s:textfield size="50"  cssClass="tin1" name="memberPerm.action" id="action" maxLength="50"></s:textfield></td>
  	    </tr>
    	  <tr>
    	    <td height="30" colspan="2" align="center"><input type="submit" class="tbtn" name="button" id="button" value="提交">&nbsp;&nbsp;
   	        <input type="button" class="tbtn" name="button2" id="button2" onClick="javascript:location.href='<s:property value="backurl"/>';" value="返回"></td>
   	    </tr>
        </s:form>
</table>
    	 		</td>
