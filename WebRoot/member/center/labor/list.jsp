...
<title><s:property value="memberInfo.account" />-参加的活动-龙爸爸成长在线</title>
...
function dellabor(id){
   if(confirm("确定删除吗？")){
      location.href="/membercenter/labordelete?ids="+id;
   }
}
</script>
</head>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>参加的活动</h2>
        <div class="note-title">
        	<s:if test="memberInfo.type==1"><a class="write-note fr" href="javascript:fowardBack('/membercenter/laborinfo?backUrl=','<s:property value="backUrl"/>')"><img src="/member/images/xxhd.png" height="26" width="83" border="0" /></a></s:if><a class="note-a" href="/membercenter/laboralllist">活动中心</a><a class="note-a note-cur" href="/membercenter/laborlist">参加的活动</a>
        </div>
        <div class="write-list">
			...
			<dl>
            	<dt>
                	<h3 class="write-title"><s:if test="#beanlist.memberInfo.id == rmemberInfo.id"><span class="note-editor"><a class="blue" href="javascript:fowardBack('/membercenter/laborinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')">编辑</a>┊<a class="blue" href="javascript:dellabor('<s:property value="#beanlist.id" escape="false" />')">删除</a></span></s:if><a class="blue" href="javascript:fowardBack('/membercenter/showlaborinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.title" escape="false" /></a></h3>
