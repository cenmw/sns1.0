...
KindEditor.ready(function(K) {
	var imageEditor = K.editor({
		...
		fileManagerJson : '/keditor/browseImageLists?foldername=uploadfiles,vedioclass',
		uploadJson : '/keditor/uploadImages?foldername=uploadfiles,vedioclass'
	});
...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/vedioclass" method="post" theme="simple" onsubmit="return checkcontentinfo()">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							bordercolor="#0099CC">
							<s:hidden name="backUrl"></s:hidden>
							<s:hidden name="vedioClass.id"></s:hidden>
							<s:hidden name="vedioClass.type"></s:hidden>
							<s:hidden name="vedioClass.mid"></s:hidden>
							<s:hidden name="vedioClass.ctime"></s:hidden>
							<s:hidden name="vedioClass.isdel"></s:hidden>							
							<tr>
							...
							<tr>
								...
								<s:textfield name="vedioClass.sort" id="sort" cssClass="tin" cssStyle="width:90px;" maxLength="50"/><em>*&nbsp;&nbsp;<span>越大越靠前！</span></em>
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">名称</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield id="title" name="vedioClass.title" maxLength="30" cssClass="tin" style="width:400px;"/>
								<em>*
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:hidden name="vedioClass.picpath" id="picpath"/>
								<s:if test="vedioClass==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:if>
								<s:elseif test="vedioClass.picpath==''||vedioClass.picpath==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:elseif>
								<s:else>
								<img src="<s:property value="vedioClass.picpath"/>" width="55" height="55" id="picpath_s"/>
								</s:else>
							...
							<tr>
								...
								<s:textarea cssClass="tarea" name="vedioClass.keyword" id="keyword" rows="5" cols="60"/>(500字)
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:textarea cssClass="tarea" name="vedioClass.description" id="description" rows="5" cols="60"/>(500字)
								</td>
							</tr>
