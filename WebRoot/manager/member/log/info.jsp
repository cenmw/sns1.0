				...
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<s:property value="memberLog.memberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">访问类型</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberLog.typename"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">访问记录时间</td>
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberLog.ctime" format="yyyy-MM-dd HH:mm:ss" />
								</td>
							</tr>
