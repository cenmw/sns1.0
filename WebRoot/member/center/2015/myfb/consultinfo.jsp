...
<title><s:property value="memberInfo.account" />-创建互动-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>创建互动</h2>

<s:form action="savemyfbconsultinfo" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
  ...
  <s:hidden name="consultInfo.state"></s:hidden>
  <s:hidden name="consultInfo.viewnumber"></s:hidden>
<table class="note-tabs1" width="640" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="561" height="50"><s:textfield id="title" name="consultInfo.title" maxLength="60" cssClass="note-input1" style="width:400px;"/>
...
document.getElementById("titlelenid").innerHTML = ""+parseInt(zjlen(title_c.value)/2)+"/30";				
  ...
  <tr>
    ...
    <td height="120"><s:textarea name="consultInfo.content" id="content" style="width:550px;height:600px;"/></td>
  </tr>
  
  <tr>
    <td height="50" align="center" valign="top"><font class="font14">奖励积分：</font></td>
    <td height="50">
	 <s:textfield name="consultInfo.score" maxLength="60" cssClass="tin" style="width:200px;"/>
	</td>
  </tr>
  
  <tr>
    <td height="50" align="center" valign="top"><font class="font14">开始时间：</font></td>
    <td height="50"><input class="infor-text" style="width:160px;" type="text" id="starttime" name="consultInfo.starttime"	value="<s:date name="consultInfo.starttime" format="yyyy-MM-dd"/>" />			
<script type="text/javascript">
jQuery(function($) {
  ...
  <tr>
    ...
    <td height="50"><input class="infor-text" style="width:160px;" type="text" id="endtime" name="consultInfo.endtime"	value="<s:date name="consultInfo.endtime" format="yyyy-MM-dd"/>" />			
<script type="text/javascript">
jQuery(function($) {
	$('#endtime').datepicker( {
		yearRange : '1920:2050', //取值范围.
