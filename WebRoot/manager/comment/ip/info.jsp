...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/commentword" method="post" theme="simple">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							bordercolor="#0099CC">
							<s:hidden name="backUrl"></s:hidden>
							<s:hidden name="commentWord.id"></s:hidden>	
							<s:hidden name="commentWord.ctime"></s:hidden>						
							<tr>
								<td colspan="2" class="yh">添加 / 修改 信息&nbsp;</td>
							</tr>							
							
							<tr>
								<td width="20%" class="yh">屏蔽词</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield id="title" name="commentWord.words" maxLength="30" cssClass="tin" style="width:400px;"/>
								</td>
							</tr>
