				...
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<s:property value="memberPraise.memberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">赞分类</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberPraise.typename"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">赞时间</td>
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberPraise.ctime" format="yyyy-MM-dd" />
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">赞对象名称</td>
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:property value="memberPraise.classname"/>	
								</td>
							</tr>
