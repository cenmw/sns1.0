...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
		...
		<div class="arc-list">
			...
			<a <s:if test="#beanlist.id == searchcid">class="cur"</s:if> href="javascript:fowardBack('/membercenter/learnlist?searchcid=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.title" escape="false" /></a>
			</s:iterator>        	
        </div>
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<a class="blue" href="javascript:fowardBackchild('/membercenter/showlearninfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=')"><s:property value="#beanlist.title" escape="false" /></a>
				</td>
				...
				<td>
				<a class="blue" href="javascript:fowardBackchild('/membercenter/showlearninfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=')">进入</a>
				</td>
			</tr>
			</s:iterator>
