...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/vedio" method="post" theme="simple" onsubmit="return checkcontentinfo()">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							bordercolor="#0099CC">
							...
							<tr>
								<td width="20%" class="yh">视频类型</td>
								<td width="80%" height="30" style="color:#FF0000">&nbsp;&nbsp;
								<s:if test="vedioInfo.type==2">管理员发布</s:if><s:elseif test="vedioInfo.type==1">机构发布</s:elseif><s:elseif test="vedioInfo.type==0">学生发布</s:elseif>
								</td>
							</tr>
							
							<s:if test="vedioInfo.type==2 || vedioInfo.type==1">
							<tr>
								...
								<script>
								document.getElementById("cid").value='<s:property value="vedioInfo.cid"/>';
								</script>							
								</td>
							</tr>
							</s:if>							
							...
							<s:else>
							<s:hidden name="vedioInfo.cid"></s:hidden>	
							</s:else>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield name="vedioInfo.sort" id="sort" cssClass="tin" cssStyle="width:90px;" maxLength="50"/><em>*&nbsp;&nbsp;<span>越大越靠前！</span></em>
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">文章标题</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield id="title" name="vedioInfo.title" maxLength="30" cssClass="tin" style="width:400px;"/>
								<em>*
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<input id="ptime" type="text" class="tin" style="width:100px;" readonly="readonly" name="vedioInfo.ptime" value="<s:date name="vedioInfo.ptime" format="yyyy-MM-dd"/>" />		
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">文章图片</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:hidden name="vedioInfo.picpath" id="picpath"/>
								<s:if test="vedioInfo==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:if>
								<s:elseif test="vedioInfo.picpath==''||vedioInfo.picpath==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:elseif>
								<s:else>
								<img src="<s:property value="vedioInfo.picpath"/>" width="55" height="55" id="picpath_s"/>
								</s:else>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield name="vedioInfo.author" cssClass="tin" maxLength="200"/>
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">文章来源</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield name="vedioInfo.source" cssClass="tin" maxLength="250"/>
								</td>
							</tr>
							...
							<tr>
								...
								<s:textarea cssClass="tarea" name="vedioInfo.keyword" id="keyword" rows="5" cols="60"/>(500字)
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:textarea cssClass="tarea" name="vedioInfo.description" id="description" rows="5" cols="60"/>(500字)
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">文章内容</td>
								<td width="80%" height="30" style="padding-left:13px;">
								<s:textarea name="vedioInfo.content" id="content" rows="30" cols="63"/>
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">视频内容</td>
								<td width="80%" height="30" style="padding-left:13px;">
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:select id="state" list="#{0:'草稿',1:'立即发布'}" name="vedioInfo.state"></s:select>
								</td>
							</tr>
