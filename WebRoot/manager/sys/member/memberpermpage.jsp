...
function fowardBack(url,backurl){
  ...
  <div class="right">
       <div class="place"><span>当前位置：会员权限管理 > 动作列表</span></div>
	    <div class="sub">
	        <input type="button" onclick="javascript:fowardBack('/manager/sys/member/memberperm?backurl=','<s:property value="pageBean.backurl"/>')" value="添加权限 " class="l" />
	   </div>
	   <div class="right_con">
...
<%
String msg=(String)request.getSession().getAttribute("actionmsg");
