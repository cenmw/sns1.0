...
KindEditor.ready(function(K) {
	var imageEditor = K.editor({
		...
		fileManagerJson : '/keditor/browseImageLists?foldername=uploadfiles,learnwhy',
		uploadJson : '/keditor/uploadImages?foldername=uploadfiles,learnwhy'
	});
...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/learnwhy" method="post" theme="simple" onsubmit="return checkcontentinfo()">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							bordercolor="#0099CC">
							<s:hidden name="backUrl"></s:hidden>
							<s:hidden name="learnWhy.id"></s:hidden>
							<s:hidden name="learnWhy.ctime"></s:hidden>
							<s:hidden name="learnWhy.isdel"></s:hidden>							
							<tr>
							...
							<tr>
								...
								<s:textfield name="learnWhy.sort" id="sort" cssClass="tin" cssStyle="width:90px;" maxLength="50"/><em>*&nbsp;&nbsp;<span>越大越靠前！</span></em>
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">标题</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield id="title" name="learnWhy.title" maxLength="30" cssClass="tin" style="width:400px;"/>
								<em>*
