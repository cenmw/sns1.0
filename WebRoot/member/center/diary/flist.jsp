...
<title><s:property value="memberInfo.account" />-好友日记-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>好友日记</h2>
        <div class="note-title">
        	<a class="note-a" href="/membercenter/diarylist">我的日记</a><a class="note-a note-cur" href="/membercenter/fdiarylist">好友日记</a>
        </div>
        <div class="write-list">
			...
			<dl>
            	<dt>
                	<h3 class="write-title"><span class="note-editor"></span><a class="blue" href="javascript:fowardBack('/membercenter/showdiaryinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.memberInfo.account" escape="false" />:&nbsp;&nbsp;<s:if test="#beanlist.rcid>0">[转]</s:if><s:date name="#beanlist.ptime" format="yyyy-MM-dd"/></a></h3>
