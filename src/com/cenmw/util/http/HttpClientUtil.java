...
public class HttpClientUtil {
	 ...
	 * @throws Exception
	 */
	public static String httpPostWithFile(String url, String queryString,
			List<HttpParameter> files) throws Exception {
		...
		try {
			...
			for (HttpParameter param : files) {
				...
				// String type = HttpUtil.getContentType(file);
