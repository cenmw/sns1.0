				...
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<s:property value="memberPhotoGroup.memberInfo.account"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberPhotoGroup.title"/>		
								</td>
							</tr>	
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberPhotoGroup.keyword"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberPhotoGroup.description"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberPhotoGroup.ctime" format="yyyy-MM-dd" />
								</td>
							</tr>
