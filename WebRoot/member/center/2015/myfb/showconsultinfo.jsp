...
<title><s:property value="memberInfo.account" />-我的互动-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>查看互动</h2>
		...
		<div class="wenti-cn mar-t20">
            ...
            <div class="wenti-fen">
            	<span class="color99" style="margin-right:20px;">提问者悬赏：<s:property value="consultInfo.score" escape="false" />分</span> <span class="color99" style="margin-right:20px;">活动时间：<s:date name="consultInfo.starttime" format="yyyy-MM-dd"/> 至 <s:date name="consultInfo.endtime" format="yyyy-MM-dd"/></span> <span class="color99">提问者：</span><a class="blue" href="javascript:void(0)"><s:property value="consultInfo.memberInfo.account" escape="false" /></a>
            </div>
<script type="text/javascript">
