...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/memberpolice" method="post" theme="simple" onsubmit="return checkcontentinfo()">
						...
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:select id="state" list="#{1:'立即锁定',2:'立即释放'}" name="memberReport.state"></s:select>
								</td>
							</tr>
