...
public class MemberContentClassManagerAction extends BaseAction {
	/**
	 * 会员文章分类 模块
	 */
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.DeleteMEMBERCONTENTCLASS })
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.ADDMEMBERCONTENTCLASS })
	public String save() {
		String msg = "修改成功！";
	 ...
	 * @return
	 */
	@EmployeePermission(perm = { EmployeePermissionType.VIEWMEMBERCONTENTCLASS })
	public String info() {
		if (id > 0) {
	...
	public String list() {
		...
		pageBean.setAction("/manager/membercontentclass/list");
