...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>我要分享</h2>
        <div class="note-title">
        	<a class="note-a" href="/membercenter/myfxlist">我的分享</a><a class="note-a note-cur" href="/membercenter/myyfxlist">我要分享</a>
        </div>
		
		<!--发表-->
	    <div class="publish" style="margin-top:20px;margin-bottom:40px;">
	    	<ul class="publish-list">
	        	<li class="cur" onclick="location.replace('/membercenter/myyfxlist')"><i class="pub-happy"></i>表心情</li>
	            <!-- <li onclick="location.replace('/membercenter/diaryinfo?backUrl=/membercenter/myyfxlist')"><i class="pub-writer"></i>写日记</li> 
	            <li onclick="location.replace('/membercenter/contentinfo?backUrl=/membercenter/myyfxlist')"><i class="pub-article"></i>发文章</li>
	            <li onclick="location.replace('/membercenter/photoinfo?backUrl=/membercenter/myyfxlist')"><i class="pub-picuture"></i>秀相片</li>
	            <li class="last" onclick="location.replace('/membercenter/vedioinfo?backUrl=/membercenter/myyfxlist')"><i class="pub-video"></i>传视频</li>-->
	        </ul>
