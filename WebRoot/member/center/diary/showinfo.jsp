...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>查看日记</h2>
       ...
       <div class="vedio-list">
			...
			<table class="note-tabs1" width="710" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">孩子的表现是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.hzbx" escape="false" /></td>
			  </tr>	
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">表现积极的地方是什么？：</font></td>
				<td height="50" style="line-height:25px;"><s:property value="memberDiary.bxjj" escape="false" /></td>
			  </tr>	
			  
			  <tr style="padding-bottom:10px;">
				<td height="50" align="center"><font class="font14">发展空间是什么？：</font></td>
