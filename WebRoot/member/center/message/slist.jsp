...
<title><s:property value="memberInfo.account" />-发信箱-龙爸爸成长在线</title>
...
function delmessage(id){
   if(confirm("确定删除吗？")){
      location.href="/membercenter/messagedelete?type=2&ids="+id;
   }
}
</script>
</head>
		...
		<div class="infor-list">
        	<ul class="infor-ul">
				...
				<li>
                	...
                	<a class="infor-l fl"><img src="<s:property value="#beanlist.rmemberInfo.avatar" escape="false" />" height="50" width="50" border="0" /></a>
                    <div class="infor-m fl">
                    	<p><a class="blue"><strong><s:property value="#beanlist.rmemberInfo.account" escape="false" /></strong></a></p>
