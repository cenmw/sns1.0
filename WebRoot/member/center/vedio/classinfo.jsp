...
<body>
  <s:form action="vedioclasssave" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
  ...
  <s:hidden name="vedioClass.sort"></s:hidden>
  <s:hidden name="vedioClass.type"></s:hidden>
  <s:hidden name="vedioClass.picpath"></s:hidden>
  <table width="100%" cellpadding="0" cellspacing="0"
			bordercolor="#0099CC">
	   <tr>
	      <td width="10%" height="30">标题：</td>
		  <td width="90%" height="30">
			 <s:textfield id="title" name="vedioClass.title" maxLength="60" cssClass="tin" style="width:100px;"/>
