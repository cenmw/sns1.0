...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				...
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/consultclass/list" target="rightFrame">咨询分类</a></li>
				</ul>	
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/consult/list" target="rightFrame">咨询信息</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
