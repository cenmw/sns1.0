...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/membercenter/zhoulist1?type=<s:property value="type"/>"><<返回上一页</a>我的52周</h2>
<table class="note-tabs1" width="640" border="0" cellspacing="0" cellpadding="0" style="margin:30px auto;font-size:14px;"> 
  
  <tr>
    <td height="50" align="center" valign="top">&nbsp;</td>
    <td height="50" align="center" width="600" id="r_textid"></td>
  </tr>
  
  <tr id="curpagetr" style="display:none;">
    <td height="50" align="center" valign="top">&nbsp;</td>
    <td height="50" >准备好了，我们就开始第 <s:property value="day" escape="false"/>  天的内容了  点击<a class="blue" style="font-weight:bold;" href="zhouinfo2?type=<s:property value="type" escape="false" />">我准备好了</a></td>
  </tr>
