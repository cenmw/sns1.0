...
<title><s:property value="memberInfo.account" />-我的好友-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>我的好友</h2>
        <div class="note-title">
            ...
            <a class="note-a note-cur" href="/membercenter/friendlist">我的好友</a>
