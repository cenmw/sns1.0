...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/topicclass/list" target="rightFrame">测试分类</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/topic/list" target="rightFrame">测试中心</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/learnwhy/list" target="rightFrame">错误原因</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/topiclifeadvice/list" target="rightFrame">生活建议</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
