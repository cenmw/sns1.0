...
<title><s:property value="memberInfo.account" />-好友提问-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
        ...
        <s:if test="memberInfo.type==0"><a class="write-note fr" href="javascript:fowardBack('/membercenter/myzyinfo?backUrl=','<s:property value="backUrl"/>')"><input class="inputButton" type="button" value="我要提问"/></a></a></s:if>
			...
			<a class="note-a note-cur" href="/membercenter/myzyflist">好友提问</a>
			</s:if>
        </div>
        	...
        	<ul class="infor-ul">
				...
				<li>
                    ...
                    <div class="infor-m fl">
                        ...
                        <p><a href="javascript:fowardBack('/membercenter/showmyzyfinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.content" escape="false" /></a></p>
