...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/learnclass/list" target="rightFrame">学习分类</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/learn/list" target="rightFrame">学习中心</a></li>
