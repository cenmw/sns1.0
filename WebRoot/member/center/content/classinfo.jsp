...
<body>
  <s:form action="contentclasssave" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" bordercolor="#0099CC">
	   <tr>
