				...
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<s:property value="memberBlog.memberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">文章分类</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberBlog.classname"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberBlog.title"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberBlog.keyword"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberBlog.description"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<s:property value="memberBlog.content"/>		
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberBlog.ctime" format="yyyy-MM-dd" />
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:property value="memberBlog.qxname"/>
								</td>
							</tr>
