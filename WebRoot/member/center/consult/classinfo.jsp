...
<body>
  <s:form action="consultclasssave" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
  ...
  <s:hidden name="consultClass.sort"></s:hidden>
  ...
  <table width="100%" cellpadding="0" cellspacing="0"
	   ...
	   <tr>
		  ...
		  <td width="90%" height="30">
			 <s:textfield id="title" name="consultClass.title" maxLength="60" cssClass="tin" style="width:100px;"/>
