...
<title><s:property value="memberInfo.account" />-我的说说-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>我的说说</h2>
        <div class="note-title">
        	<a class="note-a note-cur" href="/membercenter/moodlist">我的说说</a><a class="note-a" href="/membercenter/fmoodlist">好友说说</a>
        </div>
        	...
        	<ul class="infor-ul">
				...
				<li>
                    ...
                    <div class="infor-m fl">
						...
						<span class="note-editor"><a class="blue" href="javascript:fowardBack('/membercenter/moodinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')">编辑</a>┊<a class="blue" href="javascript:delmood('<s:property value="#beanlist.id" escape="false" />')">删除</a></span>
                    </div>
