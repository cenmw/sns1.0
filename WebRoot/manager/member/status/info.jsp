				...
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<s:property value="memberStatus.memberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">动态分类</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberStatus.typename"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">动态时间</td>
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberStatus.ctime" format="yyyy-MM-dd" />
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">动态名称</td>
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:property value="memberStatus.classname"/>	
								</td>
							</tr>
