...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>训练中心</h2>
		...
		<ul class="xueli-list">
        	...
        	<li>
            	<p class="xl-img fl"><a href="javascript:fowardBack('/membercenter/consultalllist?searchcid=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><img src="<s:property value="#beanlist.picpath" escape="false" />" width="100" height="100" border="0" /></a></p>
                <div class="xl-word fr">
                	<h3><a class="blue" href="javascript:fowardBack('/membercenter/consultalllist?searchcid=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.title" escape="false" /></a></h3>
                    <p class="xl-word-h"><s:property value="#beanlist.description" escape="false" /></p>
                    <p class="xl-word-enter"><a class="blue" href="javascript:fowardBack('/membercenter/consultalllist?searchcid=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')">进入>></a></p>
                </div>
            </li>
			</s:iterator> 
