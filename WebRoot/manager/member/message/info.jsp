			...
			<tr>
				<td align="left">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td width="20%" class="yh">会员名称（ 发消息 ）</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberMessage.memberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">会员名称（ 接消息 ）</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:property value="memberMessage.rmemberInfo.account"/>		
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">发送时间</td>
								<td width="80%" height="30">&nbsp;&nbsp;		
								<s:date name="memberMessage.ctime" format="yyyy-MM-dd" />
								</td>
							</tr>
							
							<tr>
								<td width="20%" class="yh">消息内容</td>
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:property value="memberMessage.content"/>
								</td>
							</tr>
