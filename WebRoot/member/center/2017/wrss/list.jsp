...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
        ...
        <div class="note-title">
			<a class="write-note fr" href="javascript:fowardBack('/membercenter/wrssinfo?backUrl=','<s:property value="backUrl"/>')"><input class="inputButton" type="button" value="我要自省"/></a>
			<a class="note-a note-cur" href="/membercenter/wrsslist">吾日省身</a>
        </div>
		...
		<tbody>
			...
			<tr>
				...
				<td align="center">自我反省</td>
				<td align="center"><s:if test="#beanlist.commentnumber==0">未评</s:if><s:if test="#beanlist.commentnumber>0">已评</s:if></td>
				<td align="center"><a class="blue" href="javascript:fowardBack('/membercenter/showwrssinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')">查看</a></td>
			</tr>
			</s:iterator>
