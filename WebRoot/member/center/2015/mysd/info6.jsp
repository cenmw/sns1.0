...
<table class="note-tabs1" width="640" border="0" cellspacing="0" cellpadding="0" id="table1"> 
  <tr>
    ...
    <td height="50">第五步：请您现在再次深呼吸7次，然后，静静地看看您刚才完成的前面几步的内容，您现在感受到了什么呢？（这些是您内心的真实需求）</td>
  </tr>  
...
<form id="frm" method="post" action="/membercenter/mysdinfo7?type=<s:property value="type" escape="false" />&dpage=5&id=<s:property value="memberDiary.id" escape="false" />">     	
 <table class="note-tabs1" width="640" border="0" cellspacing="0" cellpadding="0" id="table2" style="display:none;"> 
  <tr>
    <td colspan="2" style="line-height:25px; padding-top:10px;" height="35" valign="top"><font class="font14">静静地看看您刚才完成的前面几步的内容，您现在感受到了什么呢？（这些是您内心的真实需求）(500字左右)</font></td>
  </tr>
  ...
  <tr>
    <td height="50" align="center" valign="top">&nbsp;</td>
    <td height="50"><span class="blue" style="cursor:pointer;" onclick="checkcontentinfo();">太好了，我明白了</span></td>
  </tr>
