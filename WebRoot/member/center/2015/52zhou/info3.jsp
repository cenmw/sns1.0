...
<form id="frm" method="post" action="/membercenter/savezhouinfo2" onsubmit="return checkcontentinfo()">
 ...
 <table class="note-tabs1" width="640" border="0" cellspacing="0" cellpadding="0" id="table2"  style="margin:30px auto;"> 
  ...
  <tr>
    ...
    <td height="120">
    <font class="font14" style="line-height:28px;">第【<s:property value="day/7" escape="false" />】周这样过去了，静下心回顾这周的变化，发现了什么？感受到了什么？（100字）</font><br />
  ...
  <tr>
    <td style="line-height:25px; padding-top:10px;" height="50" align="center" valign="top"><font class="font14"></font></td>
    <td height="120">
    <font class="font14">仔细地回顾与体会之后，孩子这周表现最好的是什么？针对这个表现，自己的感受什么？（100字）</font><br />
...
<%
	...
	if(msg!=null){
		out.println("<script language=\"javascript\">alert('"+(String)msg+"');location.href='/membercenter/zhouinfo4?type="+type+"'</script>");
