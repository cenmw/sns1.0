...
<s:form action="laborsave" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
...
document.getElementById("titlelenid").innerHTML = ""+parseInt(zjlen(title_c.value)/2)+"/30";				
  ...
  <tr>
    <td height="50" align="center" valign="top"><font class="font14">关键字：</font></td>
    <td height="120"><s:textarea name="laborInfo.keyword" id="keyword" rows="5" cols="62"/></td>
  </tr>
  
  <tr>
    <td height="50" align="center" valign="top"><font class="font14">描述：</font></td>
    <td height="120">
	<s:textarea name="laborInfo.description" id="description" rows="5" cols="62"/>
	</td>
  </tr>	
