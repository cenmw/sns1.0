...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
		...
		<a class="write-note fr" href="javascript:fowardBack('/membercenter/consultinfo?backUrl=','<s:property value="backUrl"/>')"><img src="/member/images/btn18.png" height="26" width="83" border="0" /></a>
			...
			<a class="note-a note-cur">好友咨询</a>
        ...
        <div class="write-list">
			...
			<dl>
            	<dt>
                	<h3 class="write-title"><span class="note-editor"></span><a class="blue" href="javascript:fowardBack('/membercenter/showconsultinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')"><s:property value="#beanlist.title" escape="false" /></a></h3>
                    <p class="color99 mar-t5">
                    	...
                    	<span class="mar-l10">权限：<s:if test="#beanlist.qx==1">仅好友解答</s:if><s:elseif test="#beanlist.qx==2">仅龙爸爸解答</s:elseif><s:else>所有人解答</s:else></span>
                    </p>
                </dt>
                <dd>
