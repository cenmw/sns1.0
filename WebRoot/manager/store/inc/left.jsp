...
<div class="left" style="">
			...
			<div class="divcenter" style="height:480px;" id="leftdiv">
				...
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/store/configinfo" target="rightFrame">消费设置</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/store/list" target="rightFrame">交易中心管理<s:property value="backUrl"/></a></li>
				</ul>	
