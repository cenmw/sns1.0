...
<title><s:property value="memberInfo.account" />-文章收藏-龙爸爸成长在线</title>
...
function delcollection(id){
   if(confirm("确定删除吗？")){
      location.href="/membercenter/collectiondelete?ids="+id+"&type=3";
   }
}
</script>
</head>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>文章收藏</h2>
        <div class="note-title">
        	<a class="note-a" href="/membercenter/vediocollectionlist?type=5">视频收藏</a><a class="note-a note-cur" href="/membercenter/collectionlist?type=3">文章收藏</a><a class="note-a" href="/membercenter/learncollectionlist?type=6">学习内容</a>
        </div>
