...
KindEditor.ready(function(K) {
	var imageEditor = K.editor({
		...
		fileManagerJson : '/keditor/browseImageLists?foldername=uploadfiles,consultclass',
		uploadJson : '/keditor/uploadImages?foldername=uploadfiles,consultclass'
	});
...
<body>
	<div style="text-align: center;">
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="left">
				<s:form action="save" namespace="/manager/consultclass" method="post" theme="simple" onsubmit="return checkcontentinfo()">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							bordercolor="#0099CC">
							<s:hidden name="backUrl"></s:hidden>
							<s:hidden name="consultClass.id"></s:hidden>
							<s:hidden name="consultClass.type"></s:hidden>
							<s:hidden name="consultClass.mid"></s:hidden>
							<s:hidden name="consultClass.ctime"></s:hidden>
							<s:hidden name="consultClass.isdel"></s:hidden>							
							<tr>
							...
							<tr>
								...
								<s:textfield name="consultClass.sort" id="sort" cssClass="tin" cssStyle="width:90px;" maxLength="50"/><em>*&nbsp;&nbsp;<span>越大越靠前！</span></em>
								</td>
							</tr>
							<tr>
								<td width="20%" class="yh">名称</td>
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:textfield id="title" name="consultClass.title" maxLength="30" cssClass="tin" style="width:400px;"/>
								<em>*
							...
							<tr>
								...
								<td width="80%" height="30">&nbsp;&nbsp;
								<s:hidden name="consultClass.picpath" id="picpath"/>
								<s:if test="consultClass==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:if>
								<s:elseif test="consultClass.picpath==''||consultClass.picpath==null">
								<img  style="display:none" width="55" height="55" id="picpath_s"/>
								</s:elseif>
								<s:else>
								<img src="<s:property value="consultClass.picpath"/>" width="55" height="55" id="picpath_s"/>
								</s:else>
							...
							<tr>
								...
								<s:textarea cssClass="tarea" name="consultClass.keyword" id="keyword" rows="5" cols="60"/>(500字)
								</td>
							</tr>
							...
							<tr>
								...
								<td width="80%" height="135">&nbsp;&nbsp;
								<s:textarea cssClass="tarea" name="consultClass.description" id="description" rows="5" cols="60"/>(500字)
								</td>
							</tr>
