...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				...
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/integral/configinfo" target="rightFrame">积分设置</a></li>
				   <li onclick="changeleft(this)"><a href="/manager/integral/list" target="rightFrame">积分信息</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
