...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				...
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/commentword/list" target="rightFrame">屏蔽词</a></li>
				</ul>
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/commentip/list" target="rightFrame">屏蔽ip</a></li>
				</ul>	
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/comment/list" target="rightFrame">评论信息</a></li>
				</ul>
				<ul>
					<li onclick="changeleft(this)"><a target="rightFrame" href="/manager/comment/faceGroupList">表情管理</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
