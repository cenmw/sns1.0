...
//添加分类
function addclass(){
	$.fn.popup({iframe:true,url:'/membercenter/contentclassinfo',type:3,title:'添加文集分类',width:400,height:200});
}
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>新文集</h2>

<s:form action="contentsave" namespace="/membercenter" method="post" theme="simple" onsubmit="return checkcontentinfo()">
...
document.getElementById("titlelenid").innerHTML = ""+parseInt(zjlen(title_c.value)/2)+"/30";				
  ...
  <tr>
    ...
    <td height="50"><s:textfield id="content" name="memberBlog.content" maxLength="30" style="width:550px;height:600px;"/></td>
  </tr>
  <tr>
