...
<title><s:property value="memberInfo.account" />-我的私信-龙爸爸成长在线</title>
		...
		<div class="infor-list">
        	<ul class="infor-ul">
				...
				<li>
                    ...
                    <div class="infor-r fr"><a class="blue" href="javascript:fowardBack('/membercenter/messageinfo?id=<s:property value="#beanlist.id" escape="false" />&backUrl=','<s:property value="backUrl"/>')">查看聊天记录</a></div>
                </li>
                </s:iterator>
