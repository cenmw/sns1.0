...
<div class="left" style="">
			...
			<div class="divcenter" id="leftdiv">
				...
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/vedioclass/list" target="rightFrame">视频分类</a></li>
				</ul>	
				<ul>
				   <li onclick="changeleft(this)"><a href="/manager/vedio/list" target="rightFrame">视频信息</a></li>
				</ul>	
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
