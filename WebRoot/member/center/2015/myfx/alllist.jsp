...
<title><s:property value="memberInfo.account" />-所有分享-龙爸爸成长在线</title>
...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="/"><<返回上一页</a>所有分享</h2>
        <div class="note-title">
        	<a class="note-a note-cur" href="/membercenter/allfxlist">所有分享</a>
        </div>
