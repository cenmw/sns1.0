...
<div class="content1 layout-control">
   ...
   <div class="content-right fl">
   		<h2 class="second-title"><a class="blue" href="<s:if test="backUrl == null">/</s:if><s:else><s:property value="backUrl"/></s:else>"><<返回上一页</a>查看文集</h2>

      <div class="vedio-list">
        	<div class="pl-title">
            	<h1><s:if test="memberBlog.rcid>0">[转]</s:if><s:property value="memberBlog.title" escape="false" /></h1>
                <p class="title-infor"><span><s:date name="memberBlog.ctime" format="yyyy-MM-dd"/></span><span>作者：<s:property value="memberBlog.memberInfo.account" escape="false" /></span><span>点击量：<s:property value="memberBlog.viewnumber" escape="false" /></span></p>
            </div>
            <div class="pl-content"><s:property value="memberBlog.content" escape="false" /></div>
            <div class="fr pl-zan"><jsp:include page="/member/center/blog/inc/fxinfo.jsp"></jsp:include></div>
            <div class="clear"></div>
			...
			<s:action name="inccomment" namespace="/membercenter" executeResult="true">
				...
				<s:param name="cid" value="memberBlog.id"></s:param>
